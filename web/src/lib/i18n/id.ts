...
export const id = {
	...
	'member.add.open': 'Tambah anggota',
	'member.add.title': 'Tambah anggota',
	'member.add.desc': 'Masukkan email untuk mengecek apakah pengguna sudah terdaftar di Wadi.',
	'member.add.emailLabel': 'Email',
	'member.add.emailPlaceholder': 'nama@perusahaan.com',
	'member.add.check': 'Cek',
	'member.add.checking': 'Mengecek…',
	'member.add.found': 'Sudah terdaftar di Wadi.',
	'member.add.foundHint': 'Bisa langsung ditambahkan ke ruang ini.',
	'member.add.notFound': 'Belum punya akun Wadi.',
	'member.add.notFoundHint': 'Kirim undangan agar mereka bergabung.',
	'member.add.addBtn': 'Tambah ke ruang',
	'member.add.close': 'Tutup',
	'member.comingSoon': 'Alur tambah/undang segera hadir.',
	'member.you': 'Anda',
